  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto pt-10 pb-6 px-4 md:px-6">
      <div className="max-w-7xl mx-auto px-4 py-2">
        {/* Top Banner */}
        <div className="glass-panel rounded-3xl p-8 md:p-10 relative overflow-hidden bg-[#0B1528] shadow-2xl mb-10">
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-6">
            <div className="shrink-0 relative">
              ...
              <div className="w-40 h-40 md:w-48 md:h-48 rounded-full bg-gradient-to-br from-[#F98E2E] to-orange-400 p-1 relative z-10">
